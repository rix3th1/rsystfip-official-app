    ...
    >
      <Grid item md>
        ...
        >
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            ...
            <Typography sx={{ color: "text.secondary" }}>
              ¿Cómo puedo ver una lista de todas las personas que han visitado
        ...
        >
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            ...
            <Typography sx={{ color: "text.secondary" }}>
              ¿Cómo hacer un agendamiento programado para una fecha o día y hora
              en específico?
            </Typography>
          </AccordionSummary>
          ...
          <AccordionDetails>
            <Typography>
              ...
              estando en la vista de calendario, seleccionar el dia dando click
              en el recuadro y dentro en el número del día ó en la barra lateral
              del calendario de agendamientos da click en semana (week) o día
              (day) para agendar en el dia que hayas seleccionado y por último
              arrastrar y soltar hasta la hora que requiera el agendamiento.
            </Typography>
            ...
            <Typography>
              ...
              calendario de agendamientos se puede cambiar fácil y sencillamente
              usando las flechas que aparecen la parte superior izquierda del
              calendario.
            </Typography>

            <Typography>
              El boton hoy (today) sirve para posicionarse fácilmente en el dia
              actual y/o fecha actual del calendario de agendamientos.
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        >
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            ...
            <Typography sx={{ color: "text.secondary" }}>
              ¿Cómo hacer un agendamiento rápido del día a día, de una persona
              que llega inmediatamente a la rectoría?
            </Typography>
          </AccordionSummary>
      ...
      <Grid item md>
        ...
        >
          ...
          <AccordionDetails>
            <Typography>
              Para ver un reporte gráfico e información visualmente mejor y más
              interactiva, se debe dirigir a la sección de
              ...
              seleccionar el rango de fecha entre cual desea ver la información.
            </Typography>
        ...
        >
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            ...
            <Typography sx={{ color: "text.secondary" }}>
              ¿Cómo generar un reporte PDF con la información de las personas
          ...
          <AccordionDetails>
            <Typography>
              ...
              <code> Reportes</code>, y dar click en el menu desplegable, luego
              seleccionar la opcion
              <code> Generar reporte de agendamientos</code>, y luego completar
              las opciones que requiera para filtrar la información, despues se
              debe dar click en
              <code> Descargar</code> ó en
              <code> Visualizar</code> para ver el reporte antes de descargarlo.
            </Typography>
            ...
            <Typography>
              ...
              navegador diferente al de una versión de escritorio, no se puede.
            </Typography>
          </AccordionDetails>
        </Accordion>
      </Grid>
