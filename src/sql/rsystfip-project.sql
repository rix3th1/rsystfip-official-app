...
CREATE TABLE `Users` (
  ...
  `gender` enum('M','F') NOT NULL COMMENT 'Campo que guarda el sexo del usuario (F|M).',
...
INSERT INTO `Users` (`id`, `first_name`, `last_name`, `gender`, `document_id`, `document_number`, `phone_number`, `email`, `password`, `role_id`) VALUES
(1, 'José Manuel', 'Mendoza Vásquez', 'M', 1, '1005773423', '3186329251', 'jmendoza23@itfip.edu.co', '$2a$10$3RS7NKeZ1mTuEheyP1K2zObEzQL3uUVagWaQlj/Il9mZ8x0H6RkCa', 2),
(2, 'Carlos Enrique', 'Lara Meneses', 'M', 1, '64858737', '3012834716', 'CLARA16@itfip.edu.co', '$2a$10$ku9fm7qvIbxytaHkcRw7luIfCAL7W3zPvXxnMgXkkcgGQ/ku69nsi', 3),
(3, 'Ricardo Andrés', 'Rojas Rico', 'M', 1, '1111122448', '3173926578', 'rrojas48@itfip.edu.co', '$2a$10$aqA6nW8IxaeJMa7jFdEcLu2eZHkFa4TGlttiTRF7j57ctmUUZAP7.', 1);
